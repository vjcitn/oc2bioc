...
### Transforming to a POST-able file
...
make_oc_POSTable = function(gr, chain=NULL, genome=NULL) {
 ...
 data.frame(chr=as.character(seqnames(gr)), pos=start(gr), ref=gr$Reference_Allele,
    alt=gr$Tumor_Seq_Allele2, samp=names(gr), var=v)
}
head(make_oc_POSTable(gr38)) # already remapped
```
